...
@womens_stores_underperforming = Store.where(womens_apparel: true).where('annual_revenue < 1000000')
@womens_stores_underperforming.each { | store | puts "name: #{store.name}, annual revenue: #{store.annual_revenue}."}